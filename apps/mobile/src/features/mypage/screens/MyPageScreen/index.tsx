...
const MyPageScreen = () => {
	...
	const cancelRequestMutation = useMutation({
		...
		onSuccess: (_data, club) => {
			...
			setRequestRemovalSuccess(
				isRejectedRequest(club) ? "deleted" : "cancelled",
			);
...
const RequestRemovalSuccessModal = ({
	...
	>
		<Pressable style={styles.cancelSuccessOverlay} onPress={onClose}>
			...
			/>
			<Pressable
				style={styles.cancelSuccessCard}
...
type ManagedClubOverlayStatus = Exclude<
	ManagedClubManagementStatus,
	"APPROVED"
>;
...
const ManageClubStatusTextLayer = ({
	status,
}: {
	status: ManagedClubManagementStatus;
}) => {
