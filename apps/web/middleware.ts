...
export const config = {
  matcher: [
    ...
    '/api/v2/managers/me/clubs/:uuid/manager-transfer-invitations',
    '/api/v2/manager-transfer-invitations/:token',
    '/api/v2/manager-transfer-invitations/:token/acceptance',
