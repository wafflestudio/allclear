...
import type { ClientType, VersionCheckResult } from "@/entities/appVersion";
import type { AppVersionRepository } from "@/repositories/appVersion";
...
const getCurrentClientType = (): ClientType =>
...
export const getAppVersionService = ({
	repositories,
