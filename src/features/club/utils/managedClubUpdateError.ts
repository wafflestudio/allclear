...
const ERROR_CONTENT_BY_STATUS: Partial<
	Record<number, ManagedClubUpdateErrorContent>
> = {
	400: {
	...
	409: {
		...
		description:
			"이미 승인된 동아리의 운영진 정보는 이 화면에서 수정할 수 없어요",
	},
};

export const getManagedClubUpdateErrorContent = (
	error: unknown,
): ManagedClubUpdateErrorContent => {
